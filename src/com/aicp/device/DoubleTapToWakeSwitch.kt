...
class DoubleTapToWakeSwitch(context: Context) : OnPreferenceChangeListener {
    ...
    companion object {
        val SETTINGS_KEY: String = DeviceSettings.Companion.KEY_SETTINGS_PREFIX + DeviceSettings.Companion.KEY_DT2W_SWITCH
        fun getFile(context: Context): String? {
            val fileName: String = context.getResources().getString(R.string.pathDoubleTapToWakeToggle)
