...
class HeadphoneGainPreference(context: Context, attrs: AttributeSet?) : Preference(context, attrs), SeekBar.OnSeekBarChangeListener {
    ...
    companion object {
        ...
        var SETTINGS_KEY: String = DeviceSettings.Companion.KEY_SETTINGS_PREFIX + DeviceSettings.Companion.KEY_HEADPHONE_GAIN
        ...
        fun getDefaultValue(context: Context): String {
            return if (isSupported) Integer.toString(context.getResources().getInteger(R.integer.audioHeadphoneGainDefault)) else Integer.toString(0)
        }
    }
    ...
    init {
        ...
        mFileName = context.getResources().getString(R.string.pathAudioHeadphoneGain)
        if (isSupported) {
            mMinValue = context.getResources().getInteger(R.integer.audioHeadphoneGainMin)
            mMaxValue = context.getResources().getInteger(R.integer.audioHeadphoneGainMax)
        }
