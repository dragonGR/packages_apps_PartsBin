...
class MicGainPreference(context: Context, attrs: AttributeSet?) : Preference(context, attrs), SeekBar.OnSeekBarChangeListener {
    ...
    companion object {
        ...
        var SETTINGS_KEY: String = DeviceSettings.Companion.KEY_SETTINGS_PREFIX + DeviceSettings.Companion.KEY_MIC_GAIN
        ...
        fun getDefaultValue(context: Context): String {
            return if (isSupported) Integer.toString(context.getResources().getInteger(R.integer.audioMicGainDefault)) else Integer.toString(0)
        }
    }
    ...
    init {
        ...
        mFileName = context.getResources().getString(R.string.pathAudioMicGain)
        if (isSupported) {
            mMinValue = context.getResources().getInteger(R.integer.audioMicGainMin)
            mMaxValue = context.getResources().getInteger(R.integer.audioMicGainMax)
        }
