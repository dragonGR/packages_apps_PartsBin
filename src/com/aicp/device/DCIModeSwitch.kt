...
object DCIModeSwitch {
    val SETTINGS_KEY: String = DeviceSettings.Companion.KEY_SETTINGS_PREFIX + DeviceSettings.Companion.KEY_DCI_SWITCH
    fun getFile(context: Context?): String? {
        val fileName: String = context.getResources().getString(R.string.pathDCIModeToggle)
