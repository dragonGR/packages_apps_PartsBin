...
class EarpieceGainPreference(context: Context, attrs: AttributeSet?) : Preference(context, attrs), SeekBar.OnSeekBarChangeListener {
    ...
    companion object {
        ...
        var SETTINGS_KEY: String = DeviceSettings.Companion.KEY_SETTINGS_PREFIX + DeviceSettings.Companion.KEY_EARPIECE_GAIN
        ...
        fun getDefaultValue(context: Context): String {
            return if (isSupported) Integer.toString(context.getResources().getInteger(R.integer.audioEarpieceDefault)) else Integer.toString(0)
        }
    }
    ...
    init {
        ...
        mFileName = context.getResources().getString(R.string.pathAudioEarpieceGain)
        if (isSupported) {
            mMinValue = context.getResources().getInteger(R.integer.audioEarpieceMin)
            mMaxValue = context.getResources().getInteger(R.integer.audioEarpieceMax)
        }
